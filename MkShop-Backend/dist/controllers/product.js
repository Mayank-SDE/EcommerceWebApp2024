...
export const newProduct = TryCatch(async (request, response, next) => {
...
export const getLatestProducts = TryCatch(async (request, response, next) => {
    let products = [];
...
//Revalidate on New , update or delete or New Order product.
export const getAllCategories = TryCatch(async (request, response, next) => {
    let categories = [];
...
export const getAdminProducts = TryCatch(async (request, response, next) => {
    let products = [];
...
export const getAllProducts = TryCatch(async (request, response, next) => {
